...
/**
 * @dev Deploy Ink
 * deploy-command: make deploy-ledger contract=src/20260616_AaveV3InkWhitelabel_PriceFeedUpdate/PriceFeedUpdate_20260616.s.sol:DeployInk chain=ink
 * verify-command: FOUNDRY_PROFILE=deploy npx catapulta-verify -b broadcast/PriceFeedUpdate_20260616.s.sol/57073/run-latest.json
 */
contract DeployInk is InkScript {
  function run() external broadcast {
    // deploy payloads
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV3InkWhitelabel_PriceFeedUpdate_20260616).creationCode
    );
